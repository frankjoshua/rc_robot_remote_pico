...
class SerialRelay:
    def __init__(self, baudrate=9600):
        ...
        input_rx = board.GP9  # Replace with actual pin numbers
        input_tx = board.GP8  # Replace with actual pin numbers
        output_rx = board.GP17  # Replace with actual pin numbers
        output_tx = board.GP16  # Replace with actual pin numbers
    ...
    def update(self):
        ...
        data = self.input_uart.read(1)  # Adjust the number of bytes as needed
        if data:
